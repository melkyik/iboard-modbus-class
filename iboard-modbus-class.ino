...
//---------------версия для фабричной клубники 1 комнаты где стоят модули 1 дали нет инверсии сигнала чтения и записи
//************** Версия для Iboard 1.2, релиз от 04.05.2022 (w5500+Atmega328P)     *************
// -------------- Реализован сброс адреса через 5 сек подтягивания к земле контакта D2 на кнопке модуля DALI
