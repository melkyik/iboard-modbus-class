...
//---------------версия для фабричной клубники 2 комната где стоят DALI 2 модули! тут инверсия на чтение и на запись!
...
#define DALI_RX_PIN_CH1   18  // канал DALI 1 А0
#define DALI_TX_PIN_CH1   19  // канал DALI 1 А1
#define DALI_RX_PIN_CH2   16  // канал DALI 2 А2
#define DALI_TX_PIN_CH2   17  // канал DALI 2 А3
#define DALI_RX_PIN_CH3   14  // канал DALI 3 А4
#define DALI_TX_PIN_CH3   15  // канал DALI 3 А5
