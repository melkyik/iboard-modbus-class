...
//************** Версия для рассыпных компонентов релиз от 25.05.2022 (w5500+Atmega328P)     *************
// -------------- пины 6RX и 7TX ресета НЕТ! нужна инверсия чтения!!   DALI[0].INV_READ=1;!!
// -------------- Плата прошивается через программатор
...
#define DALI_RX_PIN_CH1   6  // канал DALI[0] 1 А0
#define DALI_TX_PIN_CH1   7  // канал DALI[0] 1 А1
#define DALI_RX_PIN_CH2   16  // канал DALI[1] 2 А2
#define DALI_TX_PIN_CH2   17  // канал DALI[1] 2 А3
#define DALI_RX_PIN_CH3   18  // канал DALI[2] 3 А4
#define DALI_TX_PIN_CH3   19  // канал DALI[2] 3 А5
...
//-----------------DALI[0]---------------
  ...
  DALI[0].INV_READ=1;//на рассыпухе инверсия чтения!
